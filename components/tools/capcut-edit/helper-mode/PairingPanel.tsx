    ...
    <div className="rounded-xl2 border-2 border-dashed border-brand/40 bg-brandSoft/30 p-6 sm:p-8 text-center">
      ...
      <div className="mt-6 pt-5 border-t border-line/40 text-left max-w-md mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
          <a
            href="https://github.com/inhwan0988/arkvvs-capcut-helper/releases/latest/download/ARK-CapCut-Helper-0.1.2-arm64.dmg"
            target="_blank"
          ...
          <a
            href="https://github.com/inhwan0988/arkvvs-capcut-helper/releases/latest/download/ARK-CapCut-Helper-0.1.2.dmg"
            target="_blank"
            rel="noopener noreferrer"
